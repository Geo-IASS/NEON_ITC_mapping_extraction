...
# need to save compressed image and add word file
...
tiff(paste("output/",img_file_name,".tif",sep=""),width=80,height=80)
plotRGB(test,stretch="lin")
dev.off()
...
write.table(h,paste("output/",img_file_name,".tfw",sep=""),sep=",",row.names = F,col.names = F)
